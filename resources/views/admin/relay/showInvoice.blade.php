                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" readonly name="invoice_no" value="{{$inv->invoice_no}}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label> ملاحظات </label>
                                                <input name="notes" readonly value="{{$inv->notes}}" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
