        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card card-primary">
                    ...
                    <form class="form-group" action=" " id="form-id" method="get">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly name="invoice_no" value="{{Alkoumi\LaravelArabicNumbers\Numbers::ShowInArabicDigits($inv->invoice_no)}}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label>تاريخ الفاتورة</label>
                                                <input type="date" readonly name="date" value="{{date('Y-m-d', strtotime($inv->date))}}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label> ملاحظات </label>
                                                <input name="notes" readonly value="{{Alkoumi\LaravelArabicNumbers\Numbers::ShowInArabicDigits($inv->notes)}}" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('relay.index')}}" class="btn btn-secondary">رجوع</a>
                            </div>
                    </form>
                </div>
                <!-- /.card -->
