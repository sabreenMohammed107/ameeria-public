...
<tr data-id="{{$rowCount}}">
    ...
    <td>
        <div class="input-mark-inner mg-b-22">
            <input type="text"  maxlength="8"  id="opPermission{{$rowCount}}" value="{{old('opPermission'.$rowCount) }}"  name="opPermission{{$rowCount}}" oninput="opPermission({{$rowCount}})"  class="form-control oppermission" placeholder="">
        </div>
    </td>
    ...
    <td style='width: 150px;'>
        <div class="input-mark-inner mg-b-22">
            <input type="number"  id="itemprice{{$rowCount}}" step=".0001"  name="itemprice{{$rowCount}}" value="{{old('itemprice'.$rowCount) }}" oninput="itemPrice({{$rowCount}})" class="form-control" placeholder="">
        </div>
    </td>
    ...
    <div class="input-mark-inner mg-b-22">
        <input type="number" step=".0001"  id="total{{$rowCount}}" value="{{old('total'.$rowCount) }}"  name="total{{$rowCount}}" oninput="totaly({{$rowCount}})" class="form-control" placeholder="">
    </div>
    </td>
