...
<tr data-id="{{$counter}}">
    ...
    <td> <input style="width: 30px;" type="text" readonly id="firstTT{{$counter}}" value="{{$counter}}"></td>
    <td>
    ...
    <td>
        <div class="input-mark-inner mg-b-22">
            <input type="text" name="detNote{{$counter}}" value="{{$itemo->note}}" onkeydown="enterForRow(event,{{$counter}})" class="form-control" placeholder="">
        </div>
    </td>
    <td>
